    ...
    <form>
        ...
        <div class="container-fixed">
            <form class="text-center">
                ...
                <h3 class="mb-5">Bienvenido! Por favor, ingrese sus datos</h3>
      <div class="row">
        <h5 class="subtitle"> <strong>Datos personales</strong> </h5>
            ...
            <div class="col-sm-6 mb-2 form-floating">
                <input type="text" class="form-control form-control-orange" id="apellido" placeholder="apellido">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 mb-2 form-floating">
                <input type="date" class="form-control form-control-orange" id="fechaNacimiento" placeholder="fechaNaciemiento">
            ...
            <div class="col-sm-4 mb-2 form-floating">
                <input type="number" class="form-control form-control-orange" id="edad" placeholder="edad">
        ...
        <div class="row">
            ...
            <div class="col-sm-6 mb-2 form-floating">
                <input type="text" class="form-control form-control-orange" id="telefono" placeholder="telefono">
        ...
        <div class="row">
            ...
            <div class="col-sm-4 mb-2 form-floating">
                <input type="direccion" class="form-control form-control-orange" id="direccion" placeholder="direccion">
        ...
        <div class="col-md-4 mb-2 form-floating">
            <input type="text" class="form-control form-control-orange" id="CP" placeholder="name@example.com">
