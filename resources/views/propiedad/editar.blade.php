...
@section('content')
    <div class="container mt-2">
        <div class="row">
            <div class="col-lg-12 margin-tb">
                ...
                <div class="pull-right">
                    <a class="btn btn-secondary" href="{{ route('propiedad.index') }}" enctype="multipart/form-data">
                        Volver</a>
                </div>
            </div>
        </div>
        ...
        @endif
        <form action="{{ route('propiedad.update', $ciudad->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="row">
                <div class="row">
