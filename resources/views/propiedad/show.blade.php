        ...
        <form style="position: relative">
                ...
                <div class="col mb-4 justify-content-center">
                    <div class="form-outline" style="margin-bottom: 0px">
                        ...
                        @if ($propiedad->aceptaMascotas == true)
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="aceptaMascotas"
                        ...
                        @else
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="aceptaMascotas"
                                    id="flexRadioDefault1" disabled checked />
                                <label class="form-check-label" for="flexRadioDefault1"> No </label>
                            </div>
                        @endif
                    </div>
                ...
                <div class="col mb-4 text-center">
                    <div class="form-outline" style="margin-bottom: 0px">
                        ...
                        @if ($propiedad->estacionamiento == true)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="estacionamiento"
                                    id="flexRadioDefault3" disabled checked />
                                <label class="form-check-label" for="flexRadioDefault1"> Si</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" name="estacionamiento"
            ...
            <div class="row mb-4">
                ...
                <div class="col mb-4">
                    <div class="form-outline" style="margin-bottom: 0px">
                        <input type="text" class="form-control" disabled
                            value="{{ $propiedad->Periodo ? $propiedad->Periodo->nombre : '' }}" />
