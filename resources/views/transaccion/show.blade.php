    ...
    <div class="container">
        ...
        <form style="position: relative">
            ...
            <div class="row mb-4">
                ...
                <div class="col mb-4">
                    <div class="form-outline" style="margin-bottom: 0px">
                        <input type="datetime" class="form-control" disabled value="{{ $transaccion->fechaCreacion }}" />
            ...
            <div class="row mb-4">
                <div class="col mb-4">
                    <div class="form-outline" style="margin-bottom: 0px">
                        <textarea class="form-control" id="descripcion" name="descripcion" disabled rows="4">{{ $transaccion->descripcion }}</textarea>
