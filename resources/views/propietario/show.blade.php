    ...
    <form style="position: relative">
        ...
        <div class="row mb-4">
          ...
          <div class="col">
            ...
            <!-- Message input -->
  <div class="form-outline mb-4"  style="margin-bottom: 0px">
    <textarea class="form-control" id="form6Example1" rows="4">{{$propietario->descripcion}}</textarea>
            ...
            <div class="row">
                <div class="col-12">
                  <a href="{{route('propietario.create')}}">
                    <button type="submit" class="button-7 ml-3"> <a class="text-light" href="{{route('propietario.index')}}">Volver</a></button>
                  </a>
                </div>
            </div>
        </div>
