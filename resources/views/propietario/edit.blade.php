            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" id="apellido" type="text" name="apellido"
                        value="{{ $propietario->apellido }}" class="form-control" placeholder="Apellido">
                    @error('apellido')
                    <div class="text-alert">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" name="fechaNacimiento" id="fechaNacimiento"
                        value="{{ $propietario->fechaNacimiento }}" class="form-control"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input class="form-control" id="telefono" type="text" name="telefono"
                        value="{{ $propietario->telefono }}" class="form-control" placeholder="telefono">
                    @error('telefono')
                    <div class="text-alert">{{ $message }}</div>
                    @enderror
                </div>
